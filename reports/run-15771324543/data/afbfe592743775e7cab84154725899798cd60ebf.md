...
Locator: getByTestId(/^.*cbef22769aafb3dac2a2e0ffb68471e4d703eb3642b9610d996aab7eab187a80.*$/).filter({ hasText: 'success' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 60000ms
  - waiting for getByTestId(/^.*cbef22769aafb3dac2a2e0ffb68471e4d703eb3642b9610d996aab7eab187a80.*$/).filter({ hasText: 'success' })
...
- tabpanel:
  ...
  - listitem:
    ...
    - paragraph: success
  - listitem:
    - button "Receive FLOW 3 minutes ago From 0x0000...fa1aec842b":
      - img
  ...
  - listitem:
    ...
    - paragraph: success
  - listitem:
    - button "Send BETA 31 minutes ago To 0x3918...d1312Bddb8":
      - img
      - paragraph: Send BETA
    ...
    - paragraph: success
  - listitem:
    - button "Send FLOW 31 minutes ago To 0x3918...d1312Bddb8":
      - img
      - paragraph: Send FLOW
      - paragraph: 31 minutes ago
      - paragraph: To 0x3918...d1312Bddb8
    ...
    - paragraph: success
  - listitem:
    - button "Send FiatTokenProxy 31 minutes ago To 0x0000...5C27Ecab3B":
      - img
      - paragraph: Send FiatTokenProxy
      - paragraph: 31 minutes ago
      - paragraph: To 0x0000...5C27Ecab3B
    ...
    - paragraph: success
  - listitem:
    - button "Send FLOW 31 minutes ago To 0x0000...0000000000":
      - img
      - paragraph: Send FLOW
      - paragraph: 31 minutes ago
      - paragraph: To 0x0000...0000000000
    ...
    - paragraph: success
  - listitem:
    - button "Send Increment Staked FLOW 31 minutes ago To 0x0000...FA1AEC842B":
      - img
      - paragraph: Send Increment Staked FLOW
      - paragraph: 31 minutes ago
      - paragraph: To 0x0000...FA1AEC842B
    ...
    - paragraph: success
  - listitem:
    - button "Send FLOW 32 minutes ago To 0x0000...FA1AEC842B":
      - img
      - paragraph: Send FLOW
    ...
    - paragraph: success
  - listitem:
    - button "Receive FLOW 32 minutes ago From 0x0000...fa1aec842b":
      - img
      - paragraph: Receive FLOW
      - paragraph: 32 minutes ago
      - paragraph: From 0x0000...fa1aec842b
