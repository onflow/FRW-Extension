import { FLOW_BIP44_PATH } from '@onflow/flow-wallet-shared';
import { type PublicKeyAccount } from '@onflow/flow-wallet-shared';
import { DEFAULT_PASSWORD } from '@onflow/flow-wallet-shared';
