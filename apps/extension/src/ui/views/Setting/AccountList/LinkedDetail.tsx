...
const NftContent = ({
  ...
  availableNftCollection: CadenceCollectionDetails[];
  hideEmpty: boolean;
  navigateWithState: (data: CadenceCollectionDetails) => void;
}) => {
...
const LinkedDetail = () => {
  ...
  const availableNftCollection: CadenceCollectionDetails[] | undefined = useMemo(() => {
  ...
  const navigateWithState = (data: CadenceCollectionDetails) => {
